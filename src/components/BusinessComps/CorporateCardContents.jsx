                  ...
                  <div className="col-lg-6 col-md-7">
                    <div className="main-content">
                      <div className="top-area section-text">
                        ...
                        <h1 className="title">
                          The Corporate Card for Startups
                        </h1>
                        <p className="xlr">
              ...
              <div className="row cus-mar">
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="single-item">
                    ...
                    <p>
                      Get real-time notifications at your fingertips. Set
                      budgets to avoid..
                    </p>
                  </div>
                </div>
                <div className="col-lg-4 col-md-6">
                  <div className="single-item">
                    ...
                    <p>
                      No sign up, annual, or hidden fees. Get started in 5
                      minutes
                    </p>
                  </div>
                </div>
                ...
                <div className="col-md-6">
                  <div className="section-text">
                    ...
                    <p>
                      ...
                      fast, transparent. Aspire gives over 10,000 business
                ...
                <div className="col-md-6">
                  ...
                  <div className="section-bottom">
                    <ul>
                      ...
                      <li>
                        <img src="assets/images/icon/check-3.png" alt="icon" />
                        Toggle the ability to make cash withdrawals from ATMs
                        for extra security
                      </li>
                    </ul>
                  </div>
              ...
              <div className="row justify-content-center">
                <div className="col-lg-6">
                  <div className="section-header text-center">
                    ...
                    <p>
                      245m+ happy clients all around the world. Don’t just take
                      our word for it
                    </p>
                  </div>
                </div>
              ...
              <div className="row justify-content-center">
                <div className="col-xl-6 text-center">
                  ...
                  <div className="btn-area">
                    ...
                    <a href="/help-center" className="cmn-btn active">
                      Talk to an expert
                    </a>
                  </div>
                </div>
...
export default CorporateCardContents;
